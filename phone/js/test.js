/**
 * Created by saber on 2018/2/2.
 */
!function (t) {
    function o(a) {
        if (e[a])return e[a].exports;
        var l = e[a] = {exports: {}, id: a, loaded: !1};
    ...
    "use strict";
    function a() {
        s.info("%c小样，你打开Console是想窃取情报吗？那就如你所愿 @!@", "color: #3498DB;font-weight: 600;"), setTimeout(function () {
    ...
    function c() {
        var t = 0;
        p("yes", function () {
            return s.log("年轻人，眼光不错哟！这里我就偷偷给你几个秘密锦囊，打开有惊喜哦✉，别跑，有神曲!"), s.log("%c我要福利%c我要应聘%c我要学习%c我要听神曲%c,输入以上密码即可打开锦囊", "background-color:#3498DB;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#fd6a7f;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#89d04f;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#3498DB;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", ""), "↓↓请输入密码↓↓"
        }), p("no", function () {
            return s.log("年纪轻轻就撒谎，这不对呀，记得要改！不管怎样，还是给你几个秘密锦囊，打开有惊喜哦✉，别跑，有神曲!"), s.log("%c我要福利%c我要应聘%c我要学习%c我要听神曲%c,输入以上密码即可打开锦囊", "background-color:#3498DB;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#fd6a7f;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#89d04f;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", "background-color:#3498DB;color:#fff;padding: 5px 10px;margin-right: 10px;line-height:30px;border-radius: 4px;", ""), "↓↓请输入密码↓↓"
        }), p("我要福利", function () {
            var o = null;
            return o = t < 2 ? r[t] : r[2], s.log("%c", "padding:113px 75px;line-height:240px;background:url('" + o + "') no-repeat;background-size:100% 100%;"), t < 2 ? s.log("从白天到深夜，一直都可以都陪着你撸%c代码%c的美女程序员%c㊣", "color: #95A5A6;", "", "color:#3498DB") : (copy && copy("Kinvix@QQ.com"), s.log("太贪心,不给你看了！想要看更多，就快来我们团队让校花手把手教你写前端吧\n简历砸向这里:Kinvix@QQ.com(%c☑已复制到剪贴板)", "color: #95A5A6")), s.log("%c如果看不到福利，请升级的chrome", "color:#95A5A6"), t++, "♥♥♥♥♥"
        }), p("我要应聘", function () {
            return copy && copy("Kinvix@QQ.com"), s.log("不废话，快快递上你的简历，小伙伴儿们已经饥渴难耐！\n快速面试通道： %cKinvix@QQ.com (%c☑已复制到剪贴板)", "color: #fd6a7f", "color: #95A5A6"), "↗↗↗↗↗↗"
        }), p("我要学习", function () {
            return s.log("%c优秀的技术文章，卖力的撕逼大神在等着你", "color:#3498DB"), s.log("%c%c", "padding:80px;line-height:160px;background:url('http://cdn.alloyteam.com/assets/img/weixin-7531e9.gif') no-repeat center center;background-size:140px 140px;", "padding:80px;line-height:160px;background:url('http://cdn.alloyteam.com/assets/img/qq-71f7f2.gif') no-repeat center center;background-size:140px 140px;"), s.log("     ↑↑↑微信公众号↑↑↑", "        ↑↑↑QQ群162225981↑↑↑"), "赶紧拿起手机扫一扫！等你飞起！✈✈✈✈"
        }), p("我要听神曲", function () {
            return l(), s.log("%c一人我饮酒醉，MC AlloyTeam在这里等候多时啦！快带上耳机或者打开你的音响，来享受音乐的魅力。", "color:#3498DB"), s.log("%c腾讯AlloyTeam首张单曲，专为Coder打造。程序员版《成都》送给你，喜欢的朋友们点一波赞666", "color:#3498DB"), s.log("%c", "padding:100px;line-height:150px;background:url('" + i + "') no-repeat center center;background-size:160px 120px;"), s.log("%c↘↘手机扫一扫，音乐不会跑♬♬♫♫♩♪♫♪♬，好听的歌曲与朋友们一起分享吧", "color:#fd6a7f"), s.log("%c", "padding:80px;line-height:160px;background:url('" + m + "') no-repeat center center;background-size:140px 140px;"), "♥♥♥♥♥赶紧扫一扫♥♥♥♥♥"
        }), p("_start", function () {
            return setTimeout(function () {
                s.log("那么，请以%c★代码的名义★%c告诉我，你愿意加入这个帅气逼人的AlloyTeam团队吗(%cyes or no)%c?", "color:#fd6a7f;font-weight:bold;", "", "color:#fd6a7f", "")
            }, 2500), ""
        })
    }

    function p(t, o) {
        Object.defineProperty(window, t, {get: o})
    }
    ...
    var r = [e(12), e(13), e(11)], i = e(9), m = e(10), s = window.console || {
    ...
    function c() {
        ...
        var o = [], e = [];
        $.ajax({
            url: "http://www.alloyteam.com/feed/", dataType: "xml", success: function (e) {
                ...
                }), 0 == o.length && (o = e.channel.item), t(o)
            }, error: function () {
    ...
    function p(t) {
        var o = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], e = "2017-4-17", a = new Date(new Date(e).getTime() + 1e3 * (t - 1) * 3600 * 24 * 7), l = a.getDate(), c = o[a.getMonth()], p = "";
        return p = 1 === l || 21 === l || 31 === l ? l + "st" : 2 === l || 22 === l ? l + "nd" : 3 === l || 23 === l ? l + "rd" : l + "th", c + " " + p
    }

    function n() {
        $.ajax({
            url: "http://www.alloyteam.com/alloyshare/admin/cgi-bin/get_last_period", success: function (t) {
    ...
    $(document).ready(function () {
        $("#indexCarousel").addClass("show"), l(), $(window).bind("scroll", function () {
            l()
        }), c(), n()
    })
}, , , function (t, o, e) {
